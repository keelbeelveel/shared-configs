...
nmap g :Magit
map <F9> :ls
map <F1> :call deoplete#toggle()
nmap ` :source ~/.vimrc
nmap m :call Toggle_mouse()
nmap ls :call LaunchMyself()
nmap lc :call LaunchCursor()
nmap h :call CommandHelp()
...
imap s <Plug>Isurround
map! <silent> = :r !powershell.exe -Command Get-Clipboard
imap  <Plug>Isurround
...
set listchars=trail:░
set ruler
set runtimepath=~/.vim,~/.vim/plugged/dir-configs-override.vim,~/.vim/plugged/nerdcommenter,~/.vim/plugged/nerdtree,~/.vim/plugged/tagbar,~/.vim/plugged/IndexedSearch,~/.vim/plugged/vim-monokai-tasty,~/.vim/plugged/vim-airline,~/.vim/plugged/vim-airline-themes,~/.fzf,~/.vim/plugged/fzf.vim,~/.vim/plugged/FixedTaskList.vim,~/.vim/plugged/deoplete.nvim,~/.vim/plugged/nvim-yarp,~/.vim/plugged/vim-hug-neovim-rpc,~/.vim/plugged/deoplete-jedi,~/.vim/plugged/context_filetype.vim,~/.vim/plugged/jedi-vim,~/.vim/plugged/vim-autoclose,~/.vim/plugged/vim-surround,~/.vim/plugged/vim-indent-object,~/.vim/plugged/vim-indentwise,~/.vim/plugged/vim-polyglot,~/.vim/plugged/ack.vim,~/.vim/plugged/colorizer,~/.vim/plugged/vim-choosewin,~/.vim/plugged/vim-isort,~/.vim/plugged/MatchTagAlways,~/.vim/plugged/emmet-vim,~/.vim/plugged/vim-fugitive,~/.vim/plugged/vim-signify,~/.vim/plugged/YankRing.vim,~/.vim/plugged/neomake,~/.vim/plugged/numbers.vim,~/.vim/plugged/vim-devicons,~/.vim/plugged/badwolf,~/.vim/plugged/tmuxline.vim,~/.vim/plugged/vimagit,~/.vim/plugged/conque-term,~/.vim/plugged/matchit.zip,/var/lib/vim/addons,/usr/share/vim/vimfiles,/usr/share/vim/vim80,/usr/share/vim/vimfiles/after,/var/lib/vim/addons/after,~/.vim/plugged/jedi-vim/after,~/.vim/plugged/vim-polyglot/after,~/.vim/after
set shiftwidth=4
set noshowmode
set showtabline=2
set softtabstop=4
...
set shortmess=aoO
badd +0 .vimrc
badd +110 .vim/colors/badwolf.vim
argglobal
silent! argdel *
$argadd .vimrc
edit .vimrc
...
silent! normal! zE
let s:l = 504 - ((10 * winheight(0) + 19) / 39)
...
wincmd w
argglobal
if bufexists('/usr/share/vim/vim80/doc/eval.txt') | buffer /usr/share/vim/vim80/doc/eval.txt | else | edit /usr/share/vim/vim80/doc/eval.txt | endif
xnoremap <buffer> <silent> \a} `>a}`<i{
xnoremap <buffer> <silent> \a{ `>a}`<i{
xnoremap <buffer> <silent> \a) `>a)`<i(
xnoremap <buffer> <silent> \a( `>a)`<i(
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 9944 - ((9 * winheight(0) + 19) / 39)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
9944
