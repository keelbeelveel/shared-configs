...
silent only
cd /mnt/c/Users/kbelv/OneDrive/Documents/GarageRemodel
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 GarageRemodel.txt
badd +1 GarageTodo.txt
argglobal
silent! argdel *
$argadd GarageRemodel.txt
edit GarageTodo.txt
...
exe 'vert 1resize ' . ((&columns * 51 + 84) / 169)
exe 'vert 2resize ' . ((&columns * 117 + 84) / 169)
argglobal
...
wincmd w
argglobal
if bufexists('GarageRemodel.txt') | buffer GarageRemodel.txt | else | edit GarageRemodel.txt | endif
